...
bool verbose = true;  // Enable serial output
...
int hypotenuse = 472; // Initial Setting, can adjust for specific strip
float angle = 25.0;
...
void loop() {
  ...
  outgoingData.senderID = 1;  // Unique ID for this transmitter, Left is generally odd and Right is generally even
